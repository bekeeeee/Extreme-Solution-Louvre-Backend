...
exports.ArtsRepository = void 0;
const inversify_1 = require("inversify");
const db_context_1 = require("../db.context");
let ArtsRepository = class ArtsRepository {
    ...
    updateOne(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            const foundArt = yield this._dbContext.art.findById(payload.id);
            if (!foundArt) {
...
ArtsRepository = __decorate([
    (0, inversify_1.injectable)(),
    __metadata("design:paramtypes", [db_context_1.DBContext])
], ArtsRepository);
exports.ArtsRepository = ArtsRepository;
